...
if (!defined('INIT_NO_SMARTY'))
{
    ...
    $smarty->template_dir   = ROOT_PATH . 'dome/' . $_CFG['template'];
    ...
    {
        $smarty->assign('ecs_css_path', 'dome/' . $_CFG['template'] . '/style_' . $_CFG['stylename'] . '.css');
    }
    else
    {
        $smarty->assign('ecs_css_path', 'dome/' . $_CFG['template'] . '/style.css');
    }

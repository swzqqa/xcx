...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2015-2017 <a href="http://wuke.tv" target="_blank">WukeLite</a> 保留所有权利';


/* 欢迎页 */
$_LANG['welcome_title'] = 'WukeLite';
...
/* 环境检测页 */
$_LANG['checking_title'] = 'WukeLite 环境检测';
$_LANG['system_environment'] = '系统环境';
$_LANG['dir_priv_checking'] = '目录权限检测';
$_LANG['template_writable_checking'] = '矩阵可写性检查';
...
$_LANG['cannt_support_dwt'] = 'dwt';
$_LANG['cannt_support_lbi'] = 'lib';
$_LANG['cannt_support_dat'] = 'dat';
$_LANG['php_os'] = '操作系统';
...
$_LANG['all_are_writable'] = '全部可写';

/* 系统设置 */
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = 'WukeLite 配置系统';
...
$_LANG['default_friend_link'] = 'WukeLite 网上商店管理系统';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<strong>安装程序已经被锁定。</strong><br /><br />如果您确定要重新安装 WukeLite，请删除data目录下的 install.lock。';
...
$_LANG['install_done_title'] = 'WukeLite 安装成功';
$_LANG['install_error_title'] = 'WukeLite 安装程序 安装失败';
$_LANG['done'] = '恭喜您，WukeLite 已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 install 目录。';
$_LANG['go_to_view_my_WukeLite'] = '前往 WukeLite 首页';
$_LANG['go_to_view_control_panel'] = '前往 WukeLite 后台管理中心';

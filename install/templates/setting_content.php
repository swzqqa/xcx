...
<tr>
<td valign="top" class="kzs"><h2 class="passmail-title main-bg-color">配置系统</h2>
<div id="wrapper">
...
<tr>
    ...
    <td align="left"><input type="text" name="js-db-prefix"  value="wkl_" /><span class="comment">&nbsp; (<?php echo $lang['change_prefix'];?>)</span></td>
</tr>
</table>
...
<tr>
    ...
    <td align="left"><input type="text" name="js-admin-name"  value="admin" /></td>
</tr>
<tr>
...
<tr style="display:none">
    <td width="90" align="left" valign="top"><?php echo $lang['install_demo'];?></td>
    <td align="left" >
